...
% CESAR School. Revisada pelo setor de biblioteca da CESAR School em 02/04/2024.
%
% Tiago Barros <tgfb@cesar.school> Março/2024
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{abntex2/abntex2-cesarschool} 
...
\usepackage[alf,abnt-and-type=e,abnt-cite-style=1,abnt-etal-list=3,abnt-etal-cite=3,url]{abntex2/abntex2cite} 
\usepackage{abntex2/url6023} 
\usepackage{multirow}
...
% LISTA DE DIAGRAMAS
% ----------------------------------------------------------
\pdfbookmark[0]{\listofdiagramasname}{lod} % caso não tenha diagramas, comente esta linha 
\listofdiagramas* % caso não tenha diagramas, comente esta linha 
\cleardoublepage
